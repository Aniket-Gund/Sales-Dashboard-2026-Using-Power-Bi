...
Monitor total orders and unique customers
...
How many orders and customers contribute to total sales?

How do sales trend over time by year and quarter?
...
CSV data sources (Orders and Customers)

Data modeling with relationships

Power Query for basic data inspection and formatting

DAX for calculated columns and measures

KPI cards, bar charts, donut charts, and line charts
...
Customers Count KPI Card

Sales by Year and Quarter (Line Chart)
...
Product categories have uneven contribution to overall revenue
...
Aniket Gund
Built as a beginner Power BI project to demonstrate foundational skills in data modeling, DAX basics, and interactive dashboard creation.
